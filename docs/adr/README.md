...
| [ADR-0017](0017-config-connector-engine-platform-rendered-forms.md) §4 | Accepted · September 2026 | What an empty claims render does, left open there, is decided: it is never pruned automatically | [ADR-0019 §2](0019-a-file-change-deletes-no-tenant-by-itself.md) |
| [ADR-0017](0017-config-connector-engine-platform-rendered-forms.md) §8 | Accepted · September 2026 | Its open choice of which chart owns the seed Job's service account is narrowed: one per claim, or in `charts/system` | [ADR-0019 §2](0019-a-file-change-deletes-no-tenant-by-itself.md) |
| [ADR-0017](0017-config-connector-engine-platform-rendered-forms.md) §9 | Accepted · September 2026 | The retired-name step that "nothing refuses" gets an advisory check in the `systems` repo, which makes a forgotten step visible, not impossible | [ADR-0019 §3](0019-a-file-change-deletes-no-tenant-by-itself.md) |
| [ADR-0017](0017-config-connector-engine-platform-rendered-forms.md), Consequences (the ApplicationSet) | Accepted · September 2026 | "Never renamed or deleted" is enforced against merges and a background `kubectl delete`; and removing a tenant file no longer deletes its namespace by itself — the ApplicationSet never deletes an Application, and a person deletes the offboarded tenant's | [ADR-0019 §1](0019-a-file-change-deletes-no-tenant-by-itself.md) |
| [ADR-0018](0018-engine-permissions-are-a-list-in-platform-roles.md) §1, §6 | Accepted · September 2026 | Reality gate widened from three reads to four, the fourth at the organisation's scope; §1's "everything it may do" read as the intended set | [ADR-0019 §5](0019-a-file-change-deletes-no-tenant-by-itself.md) |
| [ADR-0019](0019-a-file-change-deletes-no-tenant-by-itself.md) | Accepted · September 2026 | Current; nothing later yet | — |
